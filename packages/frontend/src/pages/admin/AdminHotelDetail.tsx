...
import { ArrowLeft, Loader2, History, CheckCircle2, Clock, AlertCircle, Building2, User } from 'lucide-react'
...
export default function AdminHotelDetail() {
  ...
  const updateTaskMutation = useMutation({
    mutationFn: ({ taskId, data }: { taskId: string; data: { status: string; estimatedDate?: string | null } }) =>
    ...
    >
      ...
      <Tabs defaultValue="tasks" className="space-y-4">
        <TabsList>
          ...
          {showAuditLog && <TabsTrigger value="audit">Audit Log ({auditLogs.length})</TabsTrigger>}
        </TabsList>
          ...
          <TabsContent value="audit">
            <Card>
              <CardHeader>
                ...
                <CardDescription>History of all status changes for this hotel</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                      ...
                      <TableRow key={log.id}>
                        ...
                        <TableCell>
                          <div className="max-w-[200px]">
                            <span className="text-xs text-muted-foreground">#{log.question.serialNo}</span>
                            <p className="text-sm line-clamp-1">{log.question.checklistItem}</p>
                          </div>
                        </TableCell>
                        <TableCell>
                          {log.previousStatus ? (
                        ...
                        <TableCell>
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">{log.changedBy.role}</div>
                          </div>
                        </TableCell>
                        <TableCell>
                          {log.isAdminOverride && (
